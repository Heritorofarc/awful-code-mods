...
pub fn set_battle_info_hook(this: u64, frame: u64, unit: &Unit, text_type: i32, text: &Il2CppString, method_info: OptionalMethod){
    //this calls the original function to run, which displays the tooltip text as normal.
    call_original!(this, frame, unit, text_type, text, method_info);
    ...
    if grow > 0  {
        ...
        call_original!(this, frame, unit, text_type, new_text.into(), method_info); 
    }
}
